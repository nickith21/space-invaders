class Player {
  constructor(x, y, shape, color) {
    ...
    //this determines the speed of movement
    this.speed = 0.05;
    this.isMovingLeft = false;
    this.isMovingRight = false;
    this.isShooting = false;
    this.bullet = { x: this.x, y: this.y, s: 5 };
    this.multiplier = 1;
  }
  ...
  update() {
    ...
    if (this.isShooting) {
      // this is where you change the speed of the bullet
      this.bullet.y -= 0.1 * dt * this.multiplier;
      if (this.bullet.y < 0) {
        this.isShooting = false;
        this.bullet = {};
      }
